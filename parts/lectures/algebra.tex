...
\IfLanguageName{english}{Algebra, or more specifically, abstract algebra, is a part of mathematics concerned with algebraic structures. In contrast to linear algebra - which often marks the first contact with algebraic structures in a formal sense - we want to emphasize a certain level of generality here, but give intuitive examples nontheless.}{Die Algebra in ihrer abstrakten Form ist ein Teilgebiet der Mathematik, das sich mit algebraischen Strukturen befasst. Im Gegensatz zur linearen Algebra, welche oft den ersten Kontakt mit algebraischen Strukturen darstellt, wollen wir die abstrakte Algebra ein wenig allgemeiner halten, aber trotzdem mit schönen Beispielen anreichern.}

\IfLanguageName{english}{Methods of algebra are bound to apply to almost all other fields of mathematics and also birth other fields themselves. Representation or category theory, for example. A meaningful and reasonable goal for a first course in abstract algebra is to prove that there exists no general closed form formula for solving homogeneous equations of fifth degree or higher, in contrast to those of smaller degree.}{Methoden der Algebra finden Anwendung in fast allen anderen Bereichen der Mathematik und bringen selbst wieder neue Bereiche hervor, wie beispielsweise die Darstellungs- oder Kategorientheorie. Ein sinnvolles Ziel für einen ersten Kurs in Algebra bildet die Aussage, dass die allgemeine Nullstellengleichung eines Polynoms fünften Grades im Gegensatz zu denen kleineren Grades nicht durch Formeln lösbar ist.}

\section{\IfLanguageName{english}{Group theory}{Gruppentheorie}}

\IfLanguageName{english}{The first part of a foundation in algebra is the pursuit of knowledge about groups and their relatives: \todowarning{continue to translate here}}{Der erste Teil einer grundlegenden Algebra bildet die Beschäftigung mit Gruppen und ihren Verwandten:
